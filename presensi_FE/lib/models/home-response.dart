...
class Datum {
  ...
  bool get isTerlambat {
    if (masuk.isEmpty || masuk == "null") return false;

    try {
      final batasMasuk = DateTime.parse("2026-01-01 08:00:00");
      final jamMasuk = DateTime.parse("2026-01-01 $masuk");
      return jamMasuk.isAfter(batasMasuk);
    } catch (e) {
      return false;
    }
  }
